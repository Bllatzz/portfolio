      ...
      items: [
        {
          ...
          name: 'EzRide',
          year: '2025',
          description: 'Carona request system developed in the first semester of college, with features like login, registration, carona request, and more.',
          image: '/images/ezride.png',
          link: 'https://ezride-nine.vercel.app/',
        },
        {
          ...
          name: 'Countries API',
          year: '2023',
          description: 'API of countries with information about population and area, being able to favorite the countries and see the list of favorites',
          image: '/images/country.png',
          link: 'https://api-country-theta.vercel.app/',
        },
        {
          ...
          name: 'Valorant Guide',
          year: '2024',
          description: 'Guide of characters, weapons and maps of the game Valorant',
